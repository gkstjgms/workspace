!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(9),
      o = n.n(r);
    const i = document.querySelector(".form-data"),
      s = document.querySelector(".region-name"),
      a = document.querySelector(".api-key"),
      u = document.querySelector(".errors"),
      c = document.querySelector(".loading"),
      f = document.querySelector(".result-container"),
      l = document.querySelector(".carbon-usage"),
      p = document.querySelector(".fossil-fuel"),
      d = document.querySelector(".my-region"),
      h = document.querySelector(".clear-btn");
        ...
        await o.a
          ...
          .then((e) => {
            !(function (e) {
              ...
              console.log(e + " is closest to " + n);
              let r = t.findIndex((e) => e > n),
                o = ["#2AA364", "#F5EB4D", "#9E4229", "#381D02", "#381D02"][r];
              console.log(r, o),
                chrome.runtime.sendMessage({
                  action: "updateIcon",
                  value: { color: o },
                });
            })(Math.floor(e.data.data.carbonIntensity)),
      ...
      e.preventDefault(),
        (function (e, t) {
          localStorage.setItem("apiKey", e),
            localStorage.setItem("regionName", t),
    ...
    function g() {
      const e = localStorage.getItem("apiKey"),
        t = localStorage.getItem("regionName");
      chrome.runtime.sendMessage({
        action: "updateIcon",
        value: { color: "green" },
      }),
    ...
    i.addEventListener("submit", (e) => y(e)),
      h.addEventListener("click", (e) =>
        (function (e) {
          e.preventDefault(), localStorage.removeItem("regionName"), g();
        })(e)
      ),
      g();
  },
