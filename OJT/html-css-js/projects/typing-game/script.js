...
const quotes = [
    ...
    'Dont make people into heroes, John. Heroes dont exist. And if they did I would not be one of them.',
    'I dont have friends. Just got one.',
...
typedValueElement.addEventListener('input', () => {
    ...
    if (typedValue === currentWord && wordIndex === words.length - 1) {
        ...
        // hide textbox
        // typedValueElement.style.visibility = 'hidden'; -> 사용 시 초시계가 멈추지 않는 오류 발생
